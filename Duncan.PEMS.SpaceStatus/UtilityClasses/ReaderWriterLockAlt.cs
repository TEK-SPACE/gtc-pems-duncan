...
{
    // This class is an alternative to the ReaderWriterLock class in 
    // .NET Framework 2.0 that seems to be widely regarded as buggy and slow.  
    // This code is from: http://readerwriterlockalt.codeplex.com/
