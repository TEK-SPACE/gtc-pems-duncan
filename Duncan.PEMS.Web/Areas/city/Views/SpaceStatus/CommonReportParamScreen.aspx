...
<script type="text/javascript">
    check = function (form) {
        try {
            with (form) {
  <% if ((ViewData["supportsContentToIncludeOptions"] != null) && (Convert.ToBoolean(ViewData["supportsContentToIncludeOptions"]) == true)) {%>
...
<h2><%= ViewData["commonHeader"].ToString() %></h2>
...
<form name="form1" id="my_form" method="post" action="" onsubmit="return check( this );" style="font-size: 13px; color: Black; padding-left: 8px; border-collapse:separate;">
  ...
  <div class="rounded-corners" style="display:block; min-width:308px; max-width:308px; border:1px solid #a38d12; overflow:visible; margin-bottom:8px; padding-bottom:8px;" >
    ...
    <div style="padding-left: 12px; padding-right:4px; min-height: 18px; vertical-align: middle; margin-bottom:4px;">
  ...
  <div id="pnlRptContent" class="rounded-corners" style="display:block; min-width:308px; max-width:308px; border:1px solid #a38d12; overflow:visible; margin-bottom:8px; padding-bottom:8px;" >
    ...
    <div style="padding-left: 12px; padding-right:4px;"><label><input name="chkRptContent" id="chkRptContent_3" type="checkbox" value="inclHourlyStats" checked="checked" />Hourly Statistics</label></div>
    ...
    <div style="padding-left: 12px; padding-right:4px;"><label><input name="chkRptContent" id="chkRptContent_6" type="checkbox" value="inclDetailRecords" checked="checked" />Detail Records</label></div>
