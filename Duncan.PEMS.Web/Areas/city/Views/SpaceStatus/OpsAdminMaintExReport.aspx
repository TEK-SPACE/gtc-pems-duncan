...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
	<%:"Operations, Admin & Maintenance Exceptions Report"%>
</asp:Content>
...
<style type="text/css">
    ...
    .repTypeElementNotDisplayed { display:none; }
</style>
...
<h2><%:"Operations, Admin & Maintenance Exceptions Reporting"%></h2>
...
<%-- Start -- Report Type parameters --%>
  <div class="rounded-corners" style="display:block; min-width:408px; max-width:408px; border:1px solid #a38d12; overflow:visible; margin-bottom:8px; padding-bottom:8px;" >
    <div style="background-color:#565ba3; padding-right:1px; width:99%; overflow:hidden; margin:1px; outline:none; padding-bottom:2px;  
        ...
        "><span style="font-size: 13px; padding-left:6px; color:White; font-weight:bold;">Report Type:</span></div>

    <div style="padding-left: 12px; padding-right:4px; min-height: 18px; vertical-align: middle;">
        <label><input id="RepTypeChoiceDefault" type="radio" name="RepTypeRBtn" value="pnlCurrentStatus" checked="checked" />Current Status</label>
    </div>
    <div style="padding-left: 12px; padding-right:4px; padding-bottom:4px; min-height: 18px; vertical-align: middle;">
        <label><input type="radio" name="RepTypeRBtn" value="pnlHistorical" />Historical Data</label>
        <div id="pnlHistorical" class="repTypeElementNotDisplayed" style="padding-left: 24px; display: inline-block; vertical-align: middle;">
  ...
  <div id="pnlRptContent" class="rounded-corners" style="display:block; min-width:408px; max-width:408px; border:1px solid #a38d12; overflow:visible; margin-bottom:8px; padding-bottom:8px;" >
    <div style="background-color:#565ba3; padding-right:1px; width:99%; overflow:hidden; margin:1px; outline:none; padding-bottom:2px;  
        -moz-border-top-left-radius: 20px; -webkit-border-top-left-radius: 20px; -khtml-border-top-left-radius: 20px; border-top-left-radius: 6px;
        -moz-border-top-right-radius: 20px; -webkit-border-top-right-radius: 20px; -khtml-border-top-right-radius: 20px; border-top-right-radius: 6px;
  ...
  <script type="text/javascript">
      $(document).ready(function () {
          ...
          $("#RepTypeChoiceDefault").attr("checked", true);
    ...
    <script type="text/javascript">
        ...
        $("div.repTypeElementNotDisplayed").hide();
        $("#ScopeChoiceDefault").attr("checked", true);
        $("#RepTypeChoiceDefault").attr("checked", true);
    </script>
    ...
    <%-- Click event for the radio buttons in "Report Type" group. We want to show the date range only when user chooses historical reporting instead of current status reporting --%>
    <script type="text/javascript">
        $(document).ready(function () {
            $("input[name$='RepTypeRBtn']").click(function () {

                var test = $(this).val();
                $("div.repTypeElementNotDisplayed").hide();
                $("div.repTypeElementNotDisplayed_Sometimes").hide();
                $("#" + test).show();
            });
        });
    </script>
