...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
	Overstay Violation Enforcement Report
</asp:Content>
...
<h2>Space Overstay Violation Enforcement Reporting</h2>
...
<form name="form1" id="my_form" method="post" action="" onsubmit="return check( this );" style="font-size: 13px; color: Black; padding-left: 8px; border-collapse:separate;">
  ...
  <div id="pnlRptContent" class="rounded-corners" style="display:block; min-width:308px; max-width:308px; border:1px solid #a38d12; overflow:visible; margin-bottom:8px; padding-bottom:8px;" >
    ...
    <div style="padding-left: 12px; padding-right:4px;"><label><input name="chkRptContent" id="chkRptContent_3" type="checkbox" value="inclHourlySum" checked="checked" />Hourly summary</label></div>
    <div style="padding-left: 12px; padding-right:4px;"><label><input name="chkRptContent" id="chkRptContent_4" type="checkbox" value="inclDailySum" checked="checked" />Daily summary</label></div>
    <div style="padding-left: 12px; padding-right:4px;"><label><input name="chkRptContent" id="chkRptContent_5" type="checkbox" value="inclMonthlySum" checked="checked" />Monthly summary</label></div>
  ...
  <div class="rounded-corners" style="display:block; min-width:308px; max-width:308px; border:1px solid #a38d12; overflow:visible; margin-bottom:8px; padding-bottom:8px;" >
      <div style="background-color:#565ba3; padding-right:1px; width:99%; overflow:hidden; margin:1px; outline:none; padding-bottom:2px;  
        -moz-border-top-left-radius: 20px; -webkit-border-top-left-radius: 20px; -khtml-border-top-left-radius: 20px; border-top-left-radius: 6px;
        -moz-border-top-right-radius: 20px; -webkit-border-top-right-radius: 20px; -khtml-border-top-right-radius: 20px; border-top-right-radius: 6px;
        "><span style="font-size: 13px; padding-left:6px; color:White; font-weight:bold;">Enforcement Activity:</span>
    </div>
    <div style="padding-left: 12px; padding-right:4px; min-height: 18px; vertical-align: middle;">
        <label><input id="ActRestrictChoiceDefault" type="radio" name="ActRestrictRBtn" value="All" checked="checked" />All Activity</label>
    </div>
    <div style="padding-left: 12px; padding-right:4px; min-height: 18px; vertical-align: middle;">
        <label><input type="radio" name="ActRestrictRBtn" value="Actioned" />Actioned</label>
    </div>
    <div style="padding-left: 12px; padding-right:4px; min-height: 18px; vertical-align: middle;">
        <label><input type="radio" name="ActRestrictRBtn" value="NotActioned" />Not Actioned</label>
    </div>
    <div style="padding-left: 12px; padding-right:4px; min-height: 18px; vertical-align: middle;">
        <label><input type="radio" name="ActRestrictRBtn" value="Enforced" />Enforced</label>
    </div>
    <div style="padding-left: 12px; padding-right:4px; min-height: 18px; vertical-align: middle;">
        <label><input type="radio" name="ActRestrictRBtn" value="NotEnforced" />Not Enforced</label>
    </div>
    <div style="padding-left: 12px; padding-right:4px; min-height: 18px; vertical-align: middle;">
        <label><input type="radio" name="ActRestrictRBtn" value="Cautioned" />Cautioned</label>
    </div>
  </div>
