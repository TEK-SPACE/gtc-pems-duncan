...
.dtcnb {display: table-cell; border-bottom: 0px;}
.hcenter {text-align: center;}
.vcenter {vertical-align:middle;}
.NavyText{color:#000066;} /*#064571*/
.LCol {width:102px; padding-bottom:4px; text-align:left;}
.RCol {width:102px; padding-bottom:4px; text-align:right;}
.FRCol {display:inline-block; border-bottom: 1px solid #e8eef4; width:204px; padding-bottom:4px; text-align:right;}
.FRLeftCol {display:inline-block; width:204px; padding-bottom:4px; text-align:left;}
.FRRightCol {display:inline-block; width:204px; padding-bottom:4px; text-align:right;}
...
<script type="text/javascript">
    ...
    function refreshCurrentInfo() {
        ...
        */
        ...
        $('#partial1').load('<%= Url.Action("SpcDetailPartial","SpaceStatus") %>' + 
...
<div id="myheader" class="headerarea">
  <div style="font-style:italic; width:204px; overflow:hidden; max-height:15px; text-align:center; font-size: 14px; color:Blue; padding-bottom:4px;">Violations - Space Detail</div>
