...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
	Vehicle Sensing Event Latency Report
</asp:Content>
...
<h2>Vehicle Sensing Event Latency Reporting</h2>
  ...
  <div class="rounded-corners" style="display:block; min-width:308px; max-width:308px; border:1px solid #a38d12; overflow:visible; margin-bottom:8px;" >
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $("#startDate").datetimepicker({ dateFormat: 'yy-mm-dd', timeFormat: 'hh:mm', showOn: "both", buttonImage: "<%= Url.Content("~/Content/images/calendar.gif") %>", buttonImageOnly: true});
            <%= ViewData["ReportStartDate_JavascriptDefaulter"]%>

            $("#endDate").datetimepicker({ dateFormat: 'yy-mm-dd', timeFormat: 'hh:mm', showOn: "both", buttonImage: "<%= Url.Content("~/Content/images/calendar.gif") %>", buttonImageOnly: true});
