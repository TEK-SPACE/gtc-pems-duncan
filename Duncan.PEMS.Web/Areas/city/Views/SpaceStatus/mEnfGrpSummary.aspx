...
<title>Mobile Enforcement Group Summary</title>
...
<script type="text/javascript">
    ...
    function drilldownToSelected() {
        ...
        if (targetID != "") {
            ...
            window.location.href = '<%= Url.Action("mEnfSpcSummary","SpaceStatus") %>' + '?T=' + encodeURIComponent(targetID) + 
    ...
    function refreshCurrentInfo() {
       ...
       stopStatusRefreshTimer();
        ...
        $('#loading').css('display', 'inline-block');
        $('#partial1').load('<%= Url.Action("mEnfGrpSummaryPartial","SpaceStatus") %>' + 
...
<span id="partial1">
  <% Html.RenderPartial("pv_mEnfGrpSummaryContent"); %>
</span>
