<%@ Page Language="C#" Inherits="System.Web.Mvc.ViewPage<List<MeterReportMVC.Models.SpaceStatusModel>>" %>
...
<title>Mobile VS Space Summary</title>
...
<script type="text/javascript">
    ...
    function refreshCurrentInfo() {
        ...
        */
        ...
        $('#loading').css('display', 'inline-block');
        $('#partial1').load('<%= Url.Action("mVSSpcSummaryPartial","SpaceStatus") %>' + 
...
<div id="myheader" class="headerarea" <%-- style="position:absolute; top:0px; left:0px; overflow:hidden; color:#004475;"--%>>
  <div style="font-style:italic; width:204px; overflow:hidden; max-height:15px; text-align:center; font-size: 14px; color:Blue; padding-bottom:4px;">Vacancies - <%=ViewData["groupTypeName"]%> <%=ViewData["groupID"]%></div>
...
<span id="partial1">
  <% Html.RenderPartial("pv_mVSSpcSummaryContent"); %>
</span>

<%-- <%= MobileOccupancyStatusHelpers.VSSummaryBySpacesForGroup(this.Model, this.ViewData)%>  --%>
