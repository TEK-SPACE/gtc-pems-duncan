...
namespace Duncan.PEMS.Web.Areas.shared.Controllers
{
    ...
    public class FileUploadController : PemsController
    {
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Submit(HttpPostedFileBase files, int FileType, string FileTypeExt, string FileComment)
        {
        ...
        /// <summary>
        /// Description: This Method will calculate hasvalue for given file data
        /// ModifiedBy: Santhosh  (04/Apr/2014 - 07/Apr/2014)  
        /// </summary>
        ...
        [AcceptVerbs(HttpVerbs.Post)]
        public ActionResult ScheduleAssetJobs(string locTypeVal, string assetSelected, string fileSelected, string dateScheduled, string dateActivated)
        {
            List<string> errors = new List<string>();
            string errormsg = "";
