<%@ Control Language="C#" AutoEventWireup="true" %>
	...
	<link rel="stylesheet" type="text/css" href="Resources/css/jqui_modified2.css" />
	<link rel="stylesheet" type="text/css" href="Resources/css/base.css" />
	<link rel="stylesheet" type="text/css" href="Resources/css/main.css" />
	<link rel="stylesheet" type="text/css" href="Resources/css/animate/animate.css"/>
	<link rel="stylesheet" type="text/css" href="Resources/css/report-list-modal.css" />
	<link rel="stylesheet" type="text/css" href="Resources/css/dashboard-designer.css" />
	<link rel="stylesheet" type="text/css" href="Resources/css/new-report-dialog.css" />
	<link rel="stylesheet" type="text/css" href="Resources/css/hd-dashboard.css" />
	...
	<script type="text/javascript" src="./rs.aspx?js=yui-utilities"></script>
	<script type="text/javascript" src="./rs.aspx?js=ext-yui-adapter"></script>
	<script type="text/javascript" src="./rs.aspx?js=ext"></script>
	<script type="text/javascript" src="./rs.aspx?js=jQuery.exCanvas"></script>
	...
	<script type="text/javascript" src="./rs.aspx?js=jQuery.DashboardViewer"></script>
	<script type="text/javascript" src="Resources/js2/jquery-1.9.1.min.js"></script>
	<script type="text/javascript" src="Resources/js2/jquery-ui-1.10.0.min.js"></script>
	<script type="text/javascript" src="Resources/js2/jquery.tmpl.js"></script>
	<script type="text/javascript" src="Resources/js2/jquery.purl.js"></script>
	<script type="text/javascript" src="Resources/js2/url-settings.js"></script>
	<script type="text/javascript" src="rs.aspx?js=HtmlChartsSrc"></script>
	<script type="text/javascript" src="rs.aspx?js=highcharts-more"></script>	
	<script type="text/javascript" src="rs.aspx?js=HtmlChartsFunnelSrc"></script>
	<script type="text/javascript" src="Resources/js2/new-report-dialog.js"></script>
	<script type="text/javascript" src="Resources/js2/report-list-selector.js"></script>
	<script type="text/javascript" src="Resources/js2/dashboard-designer.js"></script>
	<script type="text/javascript" src="Resources/js2/dashboard-designer-filters.js"></script>
	<script type="text/javascript" src="Resources/js2/dashboards.js"></script>
