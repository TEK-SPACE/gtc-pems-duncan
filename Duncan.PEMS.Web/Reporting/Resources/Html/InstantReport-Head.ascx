...
<link rel="stylesheet" href="<%= Url.Content("~/Reporting/Resources/css/data-sources.css")%>" type="text/css" />
...
<script type="text/javascript" src="<%= Url.Content("~/Reporting/Resources/js/data-sources.js")%>"></script>
<script type="text/javascript" src="<%= Url.Content("~/Reporting/Resources/js/data-sources-preview.js")%>"></script>

	<script type="text/javascript" src="rs.aspx?js=ModernScripts.jquery-ui-1.9.2.animations.min"></script>
<link rel="stylesheet" href="<%= Url.Content("~/Reporting/Resources/css/charts.css")%>" type="text/css" />
...
<script type="text/javascript" src="<%= Url.Content("~/Reporting/Resources/js/charts.js")%>"></script>
<script type="text/javascript" src="<%= Url.Content("~/Reporting/Resources/js/datasources-search.js")%>"></script>
