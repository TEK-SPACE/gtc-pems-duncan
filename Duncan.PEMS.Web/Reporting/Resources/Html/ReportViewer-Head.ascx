<%@ Control AutoEventWireup="true"  Inherits="System.Web.Mvc.ViewUserControl"  %>

<title>Report viewer</title>
<link rel="stylesheet" href="rs.aspx?css=ModernStyles.jquery-ui"/>
<link rel="stylesheet" href="<%= Url.Content("~/Reporting/Resources/css/report-viewer-filter.css")%>" type="text/css" />
<%--<link rel="stylesheet" href="<%= Url.Content("~/Reporting/Resources/css/duncan.css")%>" type="text/css" />--%>
<link rel="stylesheet" href="<%= Url.Content("~/Reporting/Resources/fonts/futura.css")%>" type="text/css" />
<link rel="stylesheet" href="<%= Url.Content("~/Reporting/Resources/css/jquery.bxslider.css")%>" type="text/css" />
<link rel="stylesheet" href="rs.aspx?css=jQuery" type="text/css"  />
...
<script type="text/javascript" src="<%= Url.Content("~/Reporting/Resources/js/ReportViewerFilters.js")%>"></script>
<script type="text/javascript" src="<%= Url.Content("~/Reporting/Resources/js/jquery-ui-timepicker.js")%>"></script>
<script type="text/javascript" src="<%= Url.Content("~/Reporting/Resources/js/jquery.tmpl.js")%>"></script>
<script type="text/javascript" src="<%= Url.Content("~/Reporting/Resources/js/jquery.bxslider.js")%>"></script>
<script type="text/javascript" src="<%= Url.Content("~/Reporting/Resources/js/url-settings.js")%>"></script>
<script type="text/javascript" src="<%= Url.Content("~/Reporting/Resources/js/relative-time.js")%>"></script>
<script type="text/javascript" src="<%= Url.Content("~/Reporting/Resources/js/report-viewer-filter.js")%>"></script>
<script type="text/javascript" src="<%= Url.Content("~/Reporting/Resources/js/report-viewer-filter-settings.js")%>"></script>
<style type="text/css">
	.izenda-toolbar {
