...
function UrlSettings(customUrlRsPage) {
	...
	var urlRsDuncanPage = urlRsPage.replace('/rs.aspx', '/RsDuncan.aspx');
	...
	var urlResources = urlRsPage.replace('/rs.aspx', '/Resources');
	...
	if (typeof console != "undefined" && typeof console.log == 'function') console.log('url settings: ', result);
	return result;
}